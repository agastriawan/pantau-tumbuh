                                        ...
                                        <div class="text-center">
                                            <div class="mb-4">
                                                <a href="#" class="auth-logo">
                                                    <img src="{{ asset('assets_portal/img/logo-2.png') }}" alt="logo-dark" class="mx-auto" height="48" />
                                                </a>
                                            </div>

                                            <div class="maintenance-img">
                                                <img src="{{ asset('assets_admin/images/svg/404-error.svg')}}" class="img-fluid" alt="coming-soon">
                                            </div>
