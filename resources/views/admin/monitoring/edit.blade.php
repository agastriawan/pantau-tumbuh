                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="monitoringForm" enctype="multipart/form-data">
                            <input type="hidden" name="id" id="id" value="{{ $monitoring->id }}">
                            <div class="row">
                                    ...
                                    <select id="anak_id" name="anak_id" class="form-control">
                                        ...
                                        @foreach ($anak as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $monitoring->anak_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3 col-md-6 col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="kondisi_kesehatan"
                                        placeholder="Kondisi Kesehatan" value="{{ $monitoring->kondisi_kesehatan }}">
                                </div>
                                <div class="mb-3 col-md-6 col-lg-6">
                                    ...
                                    <select id="status_imunisasi" name="status_imunisasi" class="form-control">
                                        ...
                                        <option value="Lengkap" {{ $monitoring->status_imunisasi == 'Lengkap' ? 'selected' : '' }}>Lengkap</option>
                                        <option value="Tidak Lengkap" {{ $monitoring->status_imunisasi == 'Tidak Lengkap' ? 'selected' : '' }}>Tidak Lengkap</option>
                                        <option value="Belum Imunisasi" {{ $monitoring->status_imunisasi == 'Belum Imunisasi' ? 'selected' : '' }}>Belum Imunisasi</option>                                        
                                    </select>
                                </div>
                                <div class="mb-3 col-md-12 col-lg-12">
                                    <label for="editor" class="form-label">Pertanyaan Orang Tua</label>
                                    <textarea type="text" class="form-control" id="editor"> {{ $monitoring->pertanyaan_orang_tua }} </textarea>
                                </div>
                            </div>
                            <div class="text-end">
